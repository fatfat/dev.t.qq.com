;(function(){
	...
	tpl.mood = [
		...
		tpl.websites_appnav,
		'<div class="appsArea2">',
			'<h1 class="comp_tit">心情板</h1>',
			'<h2 class="comp_sub_tit">组件介绍</h2>',
		    '<dl class="comp_intr comp_intr_noimg">',
			'<dt>功能说明：</dt>',
		    	'<dd class="gray">使用腾讯微博心情板应用，选择要显示的功能模块，将生成的心情板功能代码，嵌入到你的网站、博客或其他网页代码中，浏览网页的用户就能看到定制用户的心情。</dd>',
		    	'<!--{*<dd class="video_demo"><span class="icon_video"></span><a href="" class="valign demo_video">视频演示</a></dd>*}-->',
		    	'<dd class="comp_use"><a href="/websites/mood?explain=1" class="btn_newcomp" title="立即使用">立即使用</a></dd>',
	  		 '</dl>',
