...
function showmsg(flag,selector,msg){//提示信息
	var html,p=selector.parent(),p1 = selector.parent(".form_input"), p2 = selector.parent(".form_element");
...
$(function(){	 
	 ...
	 $('input#app_name,input#app_url,input#app_down_url,input#app_support,textarea#app_description,input[type=checkbox],input#app_weibo,select#app_class_main,select#app_class_child').change(function(){  need_post = 1; });
