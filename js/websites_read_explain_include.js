	...
	'<div class="comp_area" id = "configboard" style="min-height:700px;width:411px;overflow:hidden;">',
		...
		'<ul class="none">',
			'<li>',
				'<div class="panel">',
					'<h4>过滤关键词</h4>',
					'<p>填写您要过滤的关键字/词/url，最多填写20个</p>',
					'<textarea size="20"  name="filter" data-error="关键词" data-rule="keyWords" rows="5"></textarea>',
				'</div>',
			'</li>',
			'<li>',
				'<div class="panel">',
					'<h4>过滤用户</h4>',
					'<p>填写您要过滤的用户微博帐号，最多填写20个</p>',
					'<textarea size="20" name="filter" data-error="微博账号" data-rule="appWeibos"  rows="5"></textarea>',
				'</div>',
			'</li>',
		'</ul>',		
