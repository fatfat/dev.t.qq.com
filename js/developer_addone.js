		...
		'<div class="formWrap">',
			'<form action="developer_update.html" method="post" class="appform" >',
				'<ul class="appinfo_certif">',
					...
					'</li>',
					'<li><label class="form_label"><em>*</em>手机号码：</label><span class="form_input"><input type="text" class="txt" name="user_phone" id="user_phone"  value="<%=developer && developer.user_phone ? developer.user_phone : ""%>" data-rule="mobilenum" data-error="手机号码" maxlength="15"></span><cite class="gray inputdes">仅限中国境内手机号码，无需加0或+86</cite>',
					'</li>',
