...
function compType9(){
	var comp_style = comp.comp_style || {"width":"100%","height":"100%","colorstyle":1,"module":15,"OfficialAccount":"api_weibo","position":0,"InsertFunction":7,"SourceUrl":"http://mat1.gtimg.com/app/tmp/read.html","InitialContent":"#阅读墙测试# 说点什么吧","PageStyle":0,"TwitterNum":20,"PicStyle":0,"HeadStyle":1};
	...
	var code2 = buildCode();
	var codestr= '<div class="code_tit">请将以下代码布署到网页的<span class="c_green">&lt;head&gt;&lt;/head&gt;</span>标签中</div>'
		   + '<div contenteditAble="true" class="code">'
		   + 
		'&lt;script type="text/javascript" src="http://mat1.gtimg.com/app/vt/js/read/import.js" charset="utf-8"&gt;&lt;/script&gt;'
		   + '</div>'
		   + '<div class="code_tit">请将以下代码部署到网页的<span class="c_green">&lt;body&gt;&lt;/body&gt;</span>中需要放置阅读墙的位置</div>'
		   + '<div contenteditAble="true" class="code">'
		   + code2
		   + '</div>'
		   ;
