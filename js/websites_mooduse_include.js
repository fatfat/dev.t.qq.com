;(function(){
	...
	tpl.mooduse_include = 
		...
		'<dl class="p1" id="act">,'
			'<dt>展示用户名</dt>,'
			'<dd><span class="form_input"><input type="text" id="assname" placeholder="请输入微博帐号名" isempty="false" data-rule="assname"  data-error="微博帐号" style="width:180px;"/></span><span style="color:red;" id="errortip"></span>,'
...
function formSubmit(){
	...
	var paras={
    		"comp_type":5, //组件类型 1、'一键分享',2'批量收听',3'话题墙',4'Q-Share',5'心情板'
...
function refreshUrl(){
	...
	_aw=0+$('#autowidth').is(":checked");//是否自动适应宽度
...
var comp_type=5;
$(this).util = $(this).util || {};
util.createScript("http://mat1.gtimg.com/app/opent/js/comp_validate.js");
