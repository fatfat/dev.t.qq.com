		...
		'<div class="formWrap">',
			'<form action="/developer/update" method="post" class="appform" >',
				...
				'<input type="hidden" name="user_type" value="2" />',
					...
					'</li>',
					'<li><label class="form_label"><em>*</em>公司电话：</label><span class="form_input"><input type="text" class="txt" name="user_tel" id="user_tel" value="<%=developer && developer.user_tel ? developer.user_tel : ""%>" data-rule="telnum" data-error="公司电话" maxlength="21" placeholder="区号-电话号码-分机号"></span><label class="gray inputdes">填写公司固定电话号码，需加区号</label>',
					'</li>',
					...
					'</li>',
					'<li><label class="form_label"><em>*</em>手机号码：</label><span class="form_input"><input type="text" class="txt" name="user_phone" id="user_phone" value="<%=developer && developer.user_phone ? developer.user_phone : ""%>" data-rule="mobilenum" data-error="手机号码" maxlength="15"></span><label class="gray inputdes">仅限中国境内手机号码，无需加0或+86</label>',
					'</li>',
