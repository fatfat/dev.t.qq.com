			...
			'</div>',
				...
				'<div class="p1" id="getCode2" style="position:absolute;left:-9999px;">',
					...
					'<div class="fcgray">请将以下代码另存为“腾讯微博签名档.vbs”到您的电脑，双击运行</div>',
							...
							'<div class="code_download">',
								...
								'下载代码',
								'<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" id="code1" width="100" height="30" align="middle">',
									'<param name="allowScriptAccess" value="always" />',
									'<param name="movie" value="http://mat1.gtimg.com/app/opent/images/websites/code1.swf" />',
									'<param name="quality" value="high" />',
									'<param name="flashVars" value="callback=downloadCode&a=0&action=save" />',
									'<param name="wmode" value="transparent" />',
									'<embed src="http://mat1.gtimg.com/app/opent/images/websites/code1.swf" name="code1" quality="high" width="100" height="30" flashVars="callback=downloadCode&a=0&action=save" wmode="transparent" align="middle" swLiveConnect="false" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer_cn" />',
								'</object>',
							'</a>',
						'</div>',
				'</div>',
				'<div class="p1" id="getCode3" style="position:absolute;left:-9999px;">',
					...
					'<div class="fcgray">请将以下代码另存为“腾讯微博签名档.vbs”到您的电脑，双击运行</div>',
									...
									'<a href="javascript:;" class="download">',
										'下载代码',
										'<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" id="code2" width="100" height="30" align="middle">',
											'<param name="allowScriptAccess" value="always" />',
											'<param name="movie" value="http://mat1.gtimg.com/app/opent/images/websites/code1.swf" />',
											'<param name="quality" value="high" />',
											'<param name="flashVars" value="action=save&a=1&callback=downloadCode" />',
											'<param name="wmode" value="transparent" />',
											'<embed src="http://mat1.gtimg.com/app/opent/images/websites/code1.swf" quality="high" name="code2" width="100" height="30" flashVars="action=save&a=1&callback=downloadCode" wmode="transparent" align="middle" swLiveConnect="false" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer_cn" />',
										'</object>',
										'</a>',
									'</div>',
