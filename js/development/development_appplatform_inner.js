var developer_appplatform_inner = 
[       
	'<ul>',
		                ...
		                '<tr>',
		                   ...
		                   '</td>',
		                    '<td valign="bottom" align="left">',
		                        '<label class="nullimg">',
		                            '<img id="app_pic2_1" src="<%=iphoneinfo && iphoneinfo.app_pic2 ? iphoneinfo : "http://mat1.gtimg.com/app/opent/images/websites/0.gif"%>" width="100" height="140" _width="320" _height="480"/>',
		                        '</label>',
		                        '<br>',
...
$(function(){   
	$(document.body).append(tmpl(developer_appplatform_inner,data));
