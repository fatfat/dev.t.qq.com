...
this.tpl.qshare_simple = [
	'var _share_tencent_weibo = function() {',
		...
		'var _text = function() {',
			...
			'return [s1, s]',
		'};',
		'var _u = "http://share.v.t.qq.com/index.php?c=share&a=index&f=q2&url=$url$&appkey=" + _appkey + "&assname=$assname$&title=$title$&pic=$pic$";',
		...
		'}',
	'};',
	'_share_tencent_weibo(null, null, document.getElementById("$share_btn$"));',
].join("\r");