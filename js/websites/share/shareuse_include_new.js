...
this.tpl.shareuse_include_new = [
	...
	//'<%if (!comp.comp_id){%><!--{*<a href="?explain=1&compat=1" target="_self" class="none">旧版</a>*}--><%}%>',
	'<div class="p1">',
	...
	function formSubmit(){
		...
		var version=[1,2][+$("#showcounter").is(":checked")], //一键分享代码版本,1 - 普通版 2 - 显示分享次数
		...
		util.createScript("/js/comp/share.js");
	    util.createScript("/js/comp/comp_validate.js");